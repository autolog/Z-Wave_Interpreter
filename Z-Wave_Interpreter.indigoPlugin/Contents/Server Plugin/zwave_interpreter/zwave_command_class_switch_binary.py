...
class ZwaveSwitchBinary:
    ...
    def __init__(self, exception_handler, logger, utility, command_classes, zw_interpretation):
        try:
            ...
            self.command_classes[ZW_SWITCH_BINARY][ZW_IDENTIFIER] = "Binary Switch"
            self.command_classes[ZW_SWITCH_BINARY][ZW_COMMANDS] = dict()
            self.command_classes[ZW_SWITCH_BINARY][ZW_COMMANDS][ZW_SWITCH_BINARY_SET] = "Set"
            self.command_classes[ZW_SWITCH_BINARY][ZW_COMMANDS][ZW_SWITCH_BINARY_GET] = "Get"
            self.command_classes[ZW_SWITCH_BINARY][ZW_COMMANDS][ZW_SWITCH_BINARY_REPORT] = "Report"
